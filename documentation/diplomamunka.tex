...
\begin{figure}[h]
	...
	\caption{Microsoft adatközpont adatok klaszterenként \cite{ghobadi_projector:_2016}}
	\label{microsoft-clasters}
\end{figure}

Amint az \ref{microsoft-clasters} ábrán látható, a kommunikáció főleg megadott szerverek között történik.
...
A Barabási-Albert gráf esetén a konstans meghatározta a "preferential attachment" számát, Erdős-Rényi gráf esetén meghatározta valósínűségét annak, hogy két csomópont kapcsolatban áll, és a csillaggráf esetén pedig a csillagok számát adja meg. 
...
Ez mellett módosított algoritmusok is hozzá lettek adva a teszteléshez, amik hivatottak voltak az úthosszra nézve jobb eredményt produkálni.
